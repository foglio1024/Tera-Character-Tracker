...
namespace TCTMain
{
    public static class ResetManager
    {
        ...
        public static void ResetDailyData()
        {
            ...
            {
                if (TCTData.Data.AccountList.Find(a => a.Id == c.AccountId).TeraClub)
                {
                    tc = 2;
                }
                else
                ...
                foreach (var d in c.Dungeons)
                {
                    ...
                    {
                        if (TCTData.Data.DungList.Find(x => x.ShortName == d.Name) != null)
                        {
                            d.Runs = TCTData.Data.DungList.Find(x => x.ShortName == d.Name).MaxBaseRuns;
                        }
                    ...
                    else
                    {
                        if (TCTData.Data.DungList.Find(x => x.ShortName == d.Name) != null)
                        {
                            d.Runs = TCTData.Data.DungList.Find(x => x.ShortName == d.Name).MaxBaseRuns * tc;
                        }
                    }
                }
            }
        ...
        public static void TryReset()
        {
            ...
            {
                ResetDailyData();
                EventsManager.SendLogEntry(new LogEntryEventArgs("Daily data has been reset."));
                EventsManager.SendNotification(new NotificationEventArgs("Daily data has been reset.", NotificationImage.Default, NotificationType.Standard, TCTData.Colors.SolidGreen, true, true, false));
            ...
            if (weeklyReset)
            {
                ...
                EventsManager.SendLogEntry(new LogEntryEventArgs("Weekly data has been reset."));
                EventsManager.SendNotification(new NotificationEventArgs("Weekly data has been reset.", NotificationImage.Default, NotificationType.Standard, TCTData.Colors.SolidGreen, true, true, false));
        ...
        public static void ResetCheck()
        {
            ...
            if (Settings.LastClosed < lastReset)
            {
                dailyReset = true;
